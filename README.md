...
the past, to can begin one new experiment/showcase... and then:
   ...
   Note: we can avoid this heavy manual handshake-procedure in our webrtc-chat using the automation of this process to can "automatically" store in back-end(maybe php-based for e.g.)the content of messeges(SDPs) in some servers(for eg.  

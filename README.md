...
How can use it(how proceed to) in manual-handshake peer-to-peer(p2p) case?
	...
	2. you: copy this link (https://stefanache.github.io/p2p_webrtc_handshake/) and send it to your...
 	        friend via email. In this email you even inform your friend about this procedure shown...
 	         in my this showcase:
	...
	6. you: click on button labeled as "Create-Offer" and waiting until will be generated/written some...
	        text in its associate textarea-box

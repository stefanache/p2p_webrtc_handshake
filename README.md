...
the past, to can begin one new experiment/showcase... and then:
   ...
   <a href="https://stefanache.github.io/p2p_webrtc_handshake/" target="_blank" title="P2P WebRTC Chat With Manual HandShake"">PS:</a> If want to use that chat in your html (even static) page then put/include in your body the following line:
